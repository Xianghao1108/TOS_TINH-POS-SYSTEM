...
export function SizeDeleteModal({ isOpen, onClose, onSubmit, sizeTitle, processing }) {
    return (
        <Modal show={isOpen} onClose={onClose}>
            <form onSubmit={onSubmit} className="p-6 text-left">
                ...
                <p className="mt-2 text-sm text-slate-650">
                    Are you sure you want to delete <span className="font-bold text-slate-900">{sizeTitle}</span>?
                </p>
