...
import { useMakerManagement } from './hooks/useMakerManagement';
import { MakerTable } from './components/MakerTable';
import { MakerFormModal } from './components/MakerFormModal';
import { MakerDeleteModal } from './components/MakerDeleteModal';
...
export default function MakersPage({ auth, makers, filters }) {
    ...
    const {
        ...
        closeModal,
        deleteDataRow
    } = useMakerManagement(auth, filters);
        ...
        <AdminLayout breadcrumb={<Breadcrumb header={headWeb} links={linksBreadcrumb} />}>
            ...
            <section className="content">
                ...
                <MakerFormModal
                    ...
                    makerExistsError={makerExistsError}
                ...
                <MakerDeleteModal
                    ...
                    makerTitle={dataEdit?.maker_title || ''}
                    processing={processing}
                />
