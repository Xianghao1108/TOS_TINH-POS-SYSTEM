...
export function CategoryDeleteModal({ isOpen, onClose, onSubmit, deleteData, processing }) {
    return (
        <Modal show={isOpen} onClose={onClose}>
            <form onSubmit={onSubmit} className="p-6 text-left">
                ...
                <p className="mt-1 text-sm text-gray-650">
                    Are you sure you want to delete <span className="text-lg font-medium text-slate-800">"{deleteData.name}"</span>?
                </p>
